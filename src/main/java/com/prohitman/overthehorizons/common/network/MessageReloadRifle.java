    ...
    public void handle(MessageReloadRifle message, Supplier<NetworkEvent.Context> ctx) {
        ...
        ctx.get().enqueueWork(() -> {
            ...
            if (thePlayer != null) {
                ...
                if (heldItem instanceof HuntingRifleItem rifleItem) {
                    ...
                    for (int i = 0; i < thePlayer.getInventory().getContainerSize(); ++i) {
                        ...
                        if (!bulletstack.isEmpty()) {
                            if (bulletstack.getItem() == ModItems.COPPER_BULLET.get()) {
                                ...
                                int bulletcapacity = 25;//rifleItem.getMaterial().getBulletCapacity();
                                ...
                                if (neededbullets != 0) {
                                    if (neededbullets <= bulletstacknum) {
                                        ...
                                        thePlayer.getInventory().removeItem(i, bulletstacknum);//.removeOne(bulletstack);
                                    }

...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GREEN_LICHENSTONE = createRegistry("green_lichenstone", () -> new LichestoneBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GREEN).randomTicks().requiresCorrectToolForDrops().strength(2.0F, 6.0F)), new Item.Properties());
    ...
    public static final RegistryObject<Block> PACKED_ROOTS = createRegistry("packed_roots", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(0.5F).sound(SoundType.MANGROVE_ROOTS)), new Item.Properties());

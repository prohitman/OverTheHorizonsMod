...
public class CreateLTProvider {
    public static @NotNull LootTableProvider create(PackOutput pOutput) {
        return new LootTableProvider(pOutput, Collections.emptySet(), List.of(new LootTableProvider.SubProviderEntry(ModBlockLoottables::new, LootContextParamSets.BLOCK)));
    }
}
